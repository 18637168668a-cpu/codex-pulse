...
[Download the DMG or ZIP](https://github.com/matyang-dev/codex-pulse/releases/tag/v0.1.1)
...
Source installation remains available for developers and troubleshooting. It requires full Xcode 15+ and Node.js 22+; see [installation guide](https://github.com/matyang-dev/codex-pulse/blob/v0.1.1/docs/INSTALL.md). The source path retains the existing scripts and local-only setup.
