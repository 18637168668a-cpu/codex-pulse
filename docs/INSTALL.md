...
[Download the v0.1.1 DMG or ZIP](https://github.com/matyang-dev/codex-pulse/releases/tag/v0.1.1). This is an ad-hoc signed, unnotarized prerelease. The universal app bundles Node.js and the bridge. Intel installation and clean-machine support remain pending validation.
